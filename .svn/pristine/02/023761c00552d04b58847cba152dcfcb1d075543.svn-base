	...
	data() {
		return {
			...
			ruleValidate: {
				...
				iParam1: [{ pattern: /^[0-9]\d{0,9}$/, message: '请正确输入10位以内数字', trigger: 'change' }],
				iParam2: [{ pattern: /^[0-9]\d{0,9}$/, message: '请正确输入10位以内数字', trigger: 'change' }],
				iParam3: [{ pattern: /^[0-9]\d{0,9}$/, message: '请正确输入10位以内数字', trigger: 'change' }],
				iParam4: [{ pattern: /^[0-9]\d{0,9}$/, message: '请正确输入10位以内数字', trigger: 'change' }],
				iParam5: [{ pattern: /^[0-9]\d{0,9}$/, message: '请正确输入10位以内数字', trigger: 'change' }],
				iParam6: [{ pattern: /^[0-9]\d{0,9}$/, message: '请正确输入10位以内数字', trigger: 'change' }]
			},
			tableData: [],
			total: 0,
			page: 1,
