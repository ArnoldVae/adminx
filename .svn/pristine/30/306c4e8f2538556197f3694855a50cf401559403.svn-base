          ...
          <el-table-column prop="vcName" label="防护区名称" align="center" width="180">
            <template slot-scope="scope">
              <span v-if="scope.row.rowShow" class="prarea">
                <el-input size="mini" placeholder="请输入内容" v-model="protectInp" @focus="get($event,'信息')"></el-input>
    ...
    <div class="protectZone-equ">
      ...
      <div class="equ-table">
        <el-table :data="equData" style="width: 100%" empty-text="暂无数据"  height="709" border>
          <el-table-column prop="equmentName" label="设备名称" align="center"  width="165">
            <template slot-scope="scope">
              <span v-if="scope.row.equrowShow" class="equArea">
                <el-input size="mini" placeholder="请输入内容" v-model="equInp" @focus="get($event,'设备')"></el-input>
                <div class="equList" v-if="equmentShow">
                  <Menu width="auto" mode="vertical">
          ...
          <el-table-column prop="equmentType" label="设备类型" align="center" width="130">
            <template slot-scope="scope">
              <el-select
                v-model="typeValue"
                placeholder="请选择"
          ...
          <el-table-column prop="param1" label="参数1" align="center" width="65">
            <template slot-scope="scope">
              <el-input
                size="small"
                v-model="param1Name"
          ...
          <el-table-column prop="param2" label="参数2" align="center" width="65">
            <template slot-scope="scope">
              <el-input
                size="small"
                v-model="param2Name"
          ...
          <el-table-column prop="param3" label="参数3" align="center" width="65">
            <template slot-scope="scope">
              <el-input
                size="small"
                class="param3Name"
...
export default {
    ...
    protectRowClcik(row, column, event){
        console.log(row);
        return;
        this.axios.getequSearchDatas({
            // id:row.id,
            unitId:this.unitId,
            protectAreaId:row.protectAreaId
    ...
    //保存
		equSave(rows, index) {
      this.equData[index].equmentName=this.equInp;
      this.equData[index].equmentType=this.typeValue;
      this.equData[index].longSortid=this.equsortName;
      this.equData[index].param1=this.param1Name;
      this.equData[index].param2=this.param2Name;
      this.equData[index].param3=this.param3Name;
