                    ...
                    <template slot-scope="scope">
                      <span v-if="scope.row.rowShow">
                        <el-input
                          ...
                          @focus="get($event,'处置')"
                        ></el-input>
                        <div class="keyList" v-if="MenuShow" :style="{'top':dispostionTop+'px','left':dispostionLeft+'px'}">
                    ...
                    <template slot-scope="scope">
                      <span v-if=" scope.row.noderowShow">
                        <el-input
                          ...
                          @focus="get($event,'启动')"
                        ></el-input>
                        <div class="keyList" v-if="MenuShow" :style="{'top':startNodeTop+'px','left':startNodeLeft+'px'}">
                          <Menu width="auto" mode="vertical">
                            <MenuItem
                              :name="item.id"
			...
			this.$api.svgFlowConfig
				...
				.then(res => {
					if (res.code == 200) {
						...
						this.startNoneData[index].vcMemo = this.startName //监视值
