<template>
	<div class="data-robot" ref="data-robot">
		<div class="org-tree-wrapper first-left-tree">
		...
		<div class="org-tree-wrapper first-right-tree">
...
export default {
	...
	methods: {
		...
		async getOrgTreeData() {
			...
			this.dataHttp.getUnitTree({ iFlag: 2 }).then(res => {
				if (res.code == 200) {
